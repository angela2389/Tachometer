...
class ExperimentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create experiment" do
    assert_difference('Experiment.count') do
      post experiments_url, params: { experiment: { completed: @experiment.completed, end_date: @experiment.end_date, name: @experiment.name, start_date: @experiment.start_date } }
    end
  ...
  test "should update experiment" do
    patch experiment_url(@experiment), params: { experiment: { completed: @experiment.completed, end_date: @experiment.end_date, name: @experiment.name, start_date: @experiment.start_date } }
